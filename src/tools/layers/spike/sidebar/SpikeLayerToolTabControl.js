import SpikeLayerToolTabControlDefaults from "./SpikeLayerToolTabControlDefaults";
 ...
 * @author Petr Kaspar
 */
class SpikeLayerToolTabControl extends AbstractLayerToolTabControl {
     ...
     */
    createDefaults() {
        return new SpikeLayerToolTabControlDefaults();
    }
     ...
     */
    createState() {
        return new SpikeLayerToolTabControlState();
    }
    ...
    addMappingInputs() {
        ...
        let input = SidebarInputFactory.createSidebarInput(DynamicClassifierSidebarInput.ID(), {
            ...
            dynamic: {
                ...
                label: 'Color',
                key: 'color',       //key under which you get values from dynamic input
                action: () => {/**/},
                options: []
            }
        });
